...
/*
 * Architecture independent structure for describing a memory map for
 * the benefit of efi_memmap_init(), saving us the need to pass four
 * parameters.
 */
...
extern int __init efi_memmap_init(struct efi_memory_map_data *data);
